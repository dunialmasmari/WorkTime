  ...
  <div>
   <v-carousel
    ...
    <v-layout class="py-4" align-center wrap justify-center>
      ...
      >
       <v-layout v-if="!getallTenders.data" class="py-4" align-center justify-center wrap>
...
export default {
  ...
  computed: {
   ...
   mounted() {
    this.loadAllTender()
    this.loadTenderMajor()
  },
  methods: {
    ...mapActions({loadAllTender:'tenders/loadAllTender',loadTenderMajor:'tenders/loadTenderMajor'}),
    reserve() {
      this.loading = true;
